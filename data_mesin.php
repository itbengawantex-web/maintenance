    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <div class="form-group">
                ...
                <input type="text" name="kode" class="form-control" placeholder="Kode Mesin" required>
            </div>
            <div class="form-group">
                <label for="">Jenis Mesin</label>
                <input type="text" name="jenis" class="form-control" placeholder="Jenis Mesin" required>
            </div>
            <div class="form-group">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" name="TbhMesin" class="btn btn-primary">Submit</button>
        </div>
        </div>
        </form>
    </div>
                ...
                <div class="card-body p-0">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            // Hitung total data
                            $result = mysqli_query($con, "SELECT * FROM data_mesin");
                            $total = mysqli_num_rows($result);
                            $pages = ceil($total / $batas);

                            // Ambil data sesuai halaman
                            $query = "SELECT * FROM data_mesin LIMIT $mulai, $batas";
